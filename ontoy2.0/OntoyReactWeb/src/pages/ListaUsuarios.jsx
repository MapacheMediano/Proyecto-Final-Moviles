...
import { getUsuarios, deleteUsuario, editarUsuario } from '../api/users';
...
const ListaUsuarios = () => {
    ...
    const handleEditarUsuario = (boleta) => {
        navigate(`/admin/editarUsuario/${boleta}`);
      };
                    ...
                    <tbody>
                        {usuarios.map((usuario) => (
                            <tr key={usuario.id}>
                                ...
                                <td>{usuario.email}</td>
                                <td>
                                    <Button onClick={() => handleEditarUsuario(usuario.boleta)} children='Editar' type='button' className='button-blue' />
                                </td>
                                <td>
